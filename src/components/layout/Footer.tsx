...
export function Footer() {
  return (
    <footer className="relative overflow-hidden border-t border-white/10 bg-[linear-gradient(180deg,rgba(27,25,23,0.96),rgba(10,10,9,0.99))] text-white">
      ...
      <div className="mx-auto w-full max-w-7xl px-6 py-8 md:px-10 md:py-12">
        <div className="grid gap-10 border-b border-white/10 pb-8 md:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] md:gap-14 md:pb-10">
          <div className="space-y-5">
            ...
            <div className="space-y-3">
              <p className="flex items-center gap-3 font-display text-lg font-bold uppercase tracking-[0.14em] md:text-2xl md:tracking-[0.2em]">
        ...
        <div className="flex flex-col gap-6 pb-5 pt-6 md:flex-row md:items-center md:justify-between">
          <div className="space-y-4">
            <div className="inline-flex flex-wrap items-center gap-3">
              <p className="inline-flex items-center text-[11px] uppercase tracking-[0.28em] text-white/45">
              ...
              {socialLinks.map((link) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-2 px-3 py-2 text-[11px] uppercase tracking-[0.28em] text-white/72 transition-colors hover:bg-white/12 hover:text-white"
                >
                  <Image
                    src={link.iconSrc}
                    alt=""
