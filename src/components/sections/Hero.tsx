  ...
  return (
    <section id="top" className="relative overflow-hidden">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-6 pb-14 pt-5 md:px-10 md:pb-32 md:pt-16">
        <FadeIn
          direction="up"
          className="flex flex-wrap items-center justify-center gap-4 text-center md:justify-start md:text-left"
        >
        ...
        <div className="grid gap-10 lg:grid-cols-[1.15fr_0.80fr]">
          <div className="space-y-6 text-center md:text-left">
            <MaskedTextReveal
              as="h1"
              className="relative z-10 mx-auto font-display font-bold text-[12vw] leading-[0.82] tracking-[-0.02em] md:mx-0 md:text-[6.5vw]"
              lastLinePaddingEm={0.23}
            >
              Ein digitales Zuhause für deine Marke.
            </MaskedTextReveal>
            <FadeIn direction="up" className="relative z-0 mt-10 md:mt-20">
